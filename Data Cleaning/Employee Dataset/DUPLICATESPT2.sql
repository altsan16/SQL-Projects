...
--returns distinct records based on lastname and firstname
SELECT DISTINCT ON (lastname, firstname) * FROM employee;



-- deletes from table employee the rows with empid not found on the query for DISTINCT records
-- meaning, it will delete all duplicates
